...
export default function Footer(props) {
  return (
    <div className="flex flex-col text-white font-fira border-t-[1px] border-gray px-10 md:px-32">
      <div className="flex justify-between mt-10 align-center">
        <div className="flex flex-col ">
          <div className="flex flex-col md:flex-row text-left text-white">
            ...
            <div className="text-2xl font-bold">{props.name+"R1"} </div>
            <div className="mt-2 md:ml-10 text-base text-center text-gray">
              <a href={"mailto:" + props.mail}>{props.mail}</a>
            </div>
          </div>
          <div className="mt-3 text-base">Software Developer</div>
        </div>
        <div className="flex flex-col">
      ...
      <div className="mt-10 mb-8 text-base text-center text-gray"></div>
    </div>
  );
}
